...
func createPaidRedeemOrderInTx(tx *gorm.DB, userID uint, product *models.Product, sku *models.ProductSKU, currency string) (*models.Order, error) {
	...
	order := &models.Order{
		...
		OrderScene:              constants.OrderSceneRedeem,
		PaidAt:                  &now,
		CreatedAt:               now,
		UpdatedAt:               now,
	}
	...
	item := &models.OrderItem{
		...
		BasePriceSnapshot:            models.NewMoneyFromDecimal(decimal.Zero),
		SitePriceSnapshot:            models.NewMoneyFromDecimal(decimal.Zero),
		SiteProfitSnapshot:           models.NewMoneyFromDecimal(decimal.Zero),
