...
var (
	...
	ErrSiteWithdrawAmountInvalid       = errors.New("site withdraw amount invalid")
	ErrSiteWithdrawChannelInvalid      = errors.New("site withdraw channel invalid")
	ErrSiteWithdrawInsufficient        = errors.New("site withdraw insufficient")
	ErrSiteWithdrawStatusInvalid       = errors.New("site withdraw status invalid")
	ErrSitePermissionDenied            = errors.New("site permission denied")
